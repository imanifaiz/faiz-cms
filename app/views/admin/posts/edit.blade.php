...
@section('form-items')
	...
	<div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::text( "post_title" , Input::old( "post_title" , $item->post_title ) , array( 'id' => 'title', 'class'=>'form-control' , 'placeholder'=>'Post Title' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::text( "post_slug" , Input::old( "post_slug" , $item->post_slug ) , array( 'id' => 'slug', 'class'=>'form-control' , 'placeholder'=>'Post Slug' ) ) }}
        </div>
    </div>
