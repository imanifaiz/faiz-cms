...
@section('heading')
	<h1>Edit Page: <small>{{ $item->post_title }}</small></h1>
@stop
...
@section('form-items')
	...
	<div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::text( "post_title" , Input::old( "post_title" , $item->post_title ) , array( 'id' => 'title', 'class'=>'form-control' , 'placeholder'=>'Page Title' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::text( "post_slug" , Input::old( "post_slug" , $item->post_slug ) , array( 'id' => 'slug', 'class'=>'form-control' , 'placeholder'=>'Page Slug' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::textarea( "post_content" , Input::old( "post_content" , $item->post_content ) , array( 'class'=>'form-control rich' , 'placeholder'=>'Page Content' ) ) }}
        </div>
    </div>
