...
abstract class ObjectBaseController extends BaseController {
	 ...
	 * @return View
	 */
	public function getNew($type = 'post')
	{
		if (!View::exists('admin.' . $this->view_key . '.new')) {
			return App::abort(404, 'Page not found');
		}

		return View::make('admin.' . $this->view_key . '.new', compact('type'));
	}
	...
	public function getEdit($id)
	{
		...
		if (!View::exists('admin.' . $this->view_key . '.edit')) {
			return App::abort(404, 'Page not found');
		}

		return View::make('admin.' . $this->view_key . '.edit')
					 ->with('item', $item);
	}
